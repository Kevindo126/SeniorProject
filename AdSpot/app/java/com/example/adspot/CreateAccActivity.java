...
public class CreateAccActivity extends AppCompatActivity {
    ...
    public void newUserAcc(View view)
    {
        ...
        if (!username.equals("") && password1.equals(password2)) {
            if (password1.length() < 7)
            {
                Toast toast=Toast.makeText(getApplicationContext(), "Error! Password must be greater than 7 characters", Toast.LENGTH_SHORT);
                toast.setGravity(Gravity.CENTER_HORIZONTAL|Gravity.BOTTOM,0,150);
                toast.show();
            ...
            {
                Toast toast=Toast.makeText(getApplicationContext(), "Error! Password must be less than 16 characters", Toast.LENGTH_SHORT);
                toast.setGravity(Gravity.CENTER_HORIZONTAL|Gravity.BOTTOM,0,150);
                toast.show();
            }
        }
        if(consumer.isChecked() ^ provider.isChecked()){
            ...
            Toast toast=Toast.makeText(getApplicationContext(), "Account Created Successful!", Toast.LENGTH_LONG);
            toast.setGravity(Gravity.CENTER_HORIZONTAL|Gravity.BOTTOM,0,150);
            toast.show();
